...
named!(pub _mnt_escape<char>, do_parse!(
...
mod test {
    ...
    #[test]
    fn test_parse_one() {
        assert_eq!(_mnt_escape(b"\\134"), IResult::Done(&b""[..], '\\'));
        assert_eq!(_mnt_escape(b"\\040"), IResult::Done(&b""[..], ' '));
        assert_eq!(_mnt_escape(b"\\011"), IResult::Done(&b""[..], '\t'));
        assert_eq!(_mnt_escape(b"\\012"), IResult::Done(&b""[..], '\n'));
    }
}
